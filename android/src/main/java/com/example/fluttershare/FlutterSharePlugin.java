    ...
    private void share(MethodCall call, Result result) {
        try {
            ...
            if (title == null || title.isEmpty()) {
                Log.e("FlutterShare", "Title null or empty");
            ...
            chooserIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
            context.startActivity(chooserIntent);

            result.success(true);
        } catch (Exception ex) {
            Log.e("FlutterShare", "Error in share", ex);
    ...
    private void shareFile(MethodCall call, Result result) {
        try {
            ...
            if (filePath == null || filePath.isEmpty()) {
                Log.e("FlutterShare", "FilePath null or empty");
            ...
            Log.e("FlutterShare", "Error in shareFile", ex);
            result.error(ex.getMessage(), null, null);
        }
    }
}
